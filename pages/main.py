...
st.write("**Note**: If a JSON Decode Error occurs, please try again by clicking the Generate Recipes button. This may happen due to an error in the syntax of the JSON file generated by GPT.")
ings = st.text_input(
