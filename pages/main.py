...
st.title("Savor")
st.subheader("Use what you have, and you will have more to savor.")
ings = st.text_input(
...
if st.button("Generate Recipes"):
    try:
        ...
        st.write("JSON Decode Error. This can occur when ingredients are not actual food ingredients or are too few and vague. Please try again with more ingredients or more specific ingredients!")
